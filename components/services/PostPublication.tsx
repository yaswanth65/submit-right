...
<div className="flex w-full max-w-[1280px] flex-col gap-8 sm:gap-10">
  <div className="flex w-full flex-col items-start gap-8 lg:flex-row lg:gap-[42px]">
    ...
    <div className="relative w-full lg:w-[620px] h-[220px] sm:h-[280px] rounded-[20px_20px_0_0] bg-[#F3F9FC] border-b-4 border-[#00A0E3] isolate overflow-hidden px-4 sm:px-7 pt-4 sm:pt-12 pb-0">
      ...
      {/* Image Wrapper */}
      <div className="relative z-10 mx-auto flex w-full max-w-[500px] h-[140px] sm:h-[180px] items-end justify-center overflow-hidden rounded-[18px] bg-white shadow-[0_0_27.1px_rgba(0,160,227,0.12)]">
        <Image
    ...
    {[1, 2, 3, 4].map((idx) => (
      <div key={idx} className="flex flex-col items-center text-center gap-4">
        <div className="flex h-[42px] w-[42px] items-center justify-center rounded-full bg-white shadow-[0_4px_12px_rgba(0,0,0,0.15)]">
          <img src="/services1/tick2.svg" alt="icon" className="w-6 h-6" />
        </div>
