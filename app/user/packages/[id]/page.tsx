...
export default function ServicesPackComponent() {
  ...
  return (
    <div className="w-full font-dm-sans mx-auto px-4 py-[14px] md:px-6 lg:px-8 md:py-8">
      
      {/* --- HEADER & PRICING --- */}
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 md:gap-8 mb-8 items-stretch">
  
  {/* --- MOBILE HEADER (Visible only on mobile, Order 1) --- */}
  <div className="lg:hidden order-1">
    <h1 className="text-[16px] md:text-[22px] font-semibold text-[#171717] mb-2 tracking-tight">
      {pageData.header.title}
    </h1>
    <p className="text-[#8A94A6] text-[12px] md:text-[14px] leading-relaxed max-w-[85%] whitespace-pre-line">
      {pageData.header.description}
    </p>
  </div>

  {/* --- LEFT COLUMN: Header & Bundle Box (Order 3 on Mobile, Order 1 on Desktop) --- */}
  <div className="lg:col-span-2 flex flex-col h-full order-3 lg:order-1">
    ...
    <div className="bg-white border border-[#EAECF0] rounded-[12px] shadow-[0_1px_3px_rgba(0,0,0,0.02)] overflow-hidden flex-1 flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 flex-1">
        {pageData.premiumServices.map((service, index) => (
          <div 
            key={service.id} 
            className={`flex items-start gap-3.5 px-4 pt-5
              ${index % 2 === 0 ? "md:border-r border-[#EAECF0]" : ""} 
              ${index < 4 ? "border-b border-[#EAECF0]" : ""}
              ${index === 4 ? "border-b md:border-b-0 border-[#EAECF0]" : ""}
            `}
          >
            ...
            <div>
              ...
              <p className="text-[14px] text-[#A0AAB5] leading-relaxed">
                {service.desc}
              </p>
            </div>
          </div>
  ...
  {/* --- RIGHT COLUMN: Pricing Box (Order 2 on Mobile, Order 2 on Desktop) --- */}
  <div className="lg:col-span-1 h-full order-2 lg:order-2">
    <div className="relative bg-[#F4E9CD] border border-[#CEA02D] rounded-[16px] overflow-hidden shadow-[0_2px_4px_rgba(0,0,0,0.02)] h-full flex flex-col">
      ...
      <div className=" px-4 pt-6 pb-4 md:p-6 flex-1 flex flex-col">
        <h2 className="text-[18px] font-semibold text-[#C59432] mb-2 mt-2">
          {pageData.pricingBox.title}
        </h2>
        ...
        <div className="space-y-3.5 mb-10 flex-1">
          {pageData.pricingBox.features.map((feature, idx) => (
            <div key={idx} className="flex items-center gap-3">
              ...
              <span className="text-[#171717] text-[14px] font-semibold">{feature}</span>
            </div>
          ))}
        </div>
        ...
        <div className="mt-auto">
          <div className="border-t border-[#E8D9B4] pt-6 mb-5">
            <div className="flex justify-between items-center mb-1.5">
              <span className="text-[#78788D] text-[14px] ">Get 6 services worth</span>
              <span className="text-[#171717] text-[14px] font-medium line-through">{pageData.pricingBox.originalPrice}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[#78788D] text-[14px] font-normal">For only:</span>
              <span className="text-[#CEA02D] text-[20px] font-medium tracking-tight">{pageData.pricingBox.discountedPrice}</span>
            </div>
          </div>
      ...
      <div className="mb-12">
        <div className="mb-5 md:mb-6">
          <h2 className="text-[18px] md:text-[24px] font-semibold text-[#171717] mb-1">
            Services available in this pack
          </h2>
          <p className="text-[#8A94A6] text-[14px] md:text-[15px]">
            Get basic publication support with this pack.
          </p>
        </div>
          ...
          {pageData.servicesAvailable.map((card) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex flex-col mt-1">
                    <h3 className="text-[14px] md:text-[16px] font-semibold text-[#171717]">{card.title}</h3>
                </div>
              </div>
              
              <p className="text-[#78788D] text-[12px] md:text-[13px] leading-relaxed flex-1 mb-6">
                {card.desc}
              </p>

              <div className="flex items-center justify-between border-t border-[#EAECF0] pt-4 mt-auto">
                <span className="text-[16px] font-semibold text-[#171717]">{card.value}</span>
                <button className="flex items-center gap-1.5 px-4 py-2 border border-[#00A0E3] bg-white text-[#00A0E3] rounded-[8px] text-[14px] font-medium hover:bg-[#F0F8FC] transition-colors">
                  View Details <ChevronRight className="w-[14px] h-[14px]" strokeWidth={2.5} />
                </button>
              </div>
            </div>
      ...
      {/* --- ENQUIRY BANNER --- */}
      <div className="bg-[#F4FAFD] border border-[#E4EEF5] rounded-[16px] px-4 py-6 md:p-6 flex flex-col md:flex-row items-center gap-6 md:gap-8 mb-12">
        <div className="w-full md:w-[200px] h-[220px] md:h-[130px] bg-[#D1DCE5] rounded-[8px] flex shrink-0 items-center justify-center text-white overflow-hidden relative">
           <ImageIcon className="w-16 h-16 text-[#A0AEBC] opacity-50" strokeWidth={1.5} />
        </div>
        <div className="flex-1">
          <h3 className="text-[18px] font-bold text-[#171717] mb-1.5">
      ...
      <div className="bg-gray-50 border border-[#EAECF0] rounded-[16px] p-6 mb-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-4">
          <div className="max-w-[85%]">
            <h3 className="text-[18px] md:text-[20px] font-semibold text-[#171717] mb-2">
              1 in 10 BELS-certified editors across the globe are associated with Editage
            </h3>
            <p className="text-[#8A94A6] text-[14px] leading-relaxed">
              Our team includes PhDs, MDs, engineers, postgraduates, and journal peer reviewers who don't just have technical competency, but also a deep understanding of your subject.
        ...
        <div className="flex flex-col md:flex-row md:items-center md:flex-wrap md:gap-y-4 pt-4">
  {additionalPageData.belsFeatures.map((feature, idx) => (
    <div
      key={feature.id}
      className={`flex items-center gap-3 py-4 md:py-0 md:mr-6 md:pr-6 ${
          idx !== additionalPageData.belsFeatures.length - 1
          ? "border-b md:border-b-0 md:border-r border-[#EAECF0]"
          : ""
      }`}
    >
      <feature.icon
          className="w-[18px] h-[18px] text-[#8A94A6] shrink-0"
          strokeWidth={2.5}
      />
      <span className="text-[14px] font-semibold text-[#525866] whitespace-nowrap">
          {feature.title}
      </span>
    </div>
  ))}
      ...
      {/* --- KEY DETAILS SECTION --- */}
      <div className="mb-16">
        <h2 className="text-[18px] md:text-[20px] font-semibold text-[#171717] mb-5 md:mb-6">Key Details</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-5">
          {/* Column 1 */}
          <div className="flex flex-col gap-3 md:gap-5">
            <div className="relative overflow-hidden bg-[#F2F8FD] rounded-[12px] p-4 md:p-6 h-full border border-[#EBF3F9]">
              <div className="relative z-10">
                <h4 className="font-bold text-[#1C1C1D] text-[16px] md:text-[18px] mb-2">{additionalPageData.keyDetails.turnaround.title}</h4>
                <p className="text-[#78788D] text-[14px] md:text-[16px]">{additionalPageData.keyDetails.turnaround.value}</p>
              </div>
              <Clock className="absolute -right-3 -top-1 w-[80px] h-[80px] text-[#D0E6F7] opacity-60 z-0" strokeWidth={1.5} />
            </div>
            <div className="relative overflow-hidden bg-[#F2F8FD] rounded-[12px] p-4 md:p-6  h-full border border-[#EBF3F9]">
              <div className="relative z-10">
                <h4 className="font-bold text-[#1C1C1D] text-[16px] md:text-[18px] mb-2">{additionalPageData.keyDetails.rate.title}</h4>
                <p className="text-[#78788D] text-[14px] md:text-[16px]">{additionalPageData.keyDetails.rate.value}</p>
              </div>
              <CircleDollarSign className="absolute -right-3 -bottom-3 w-[80px] h-[80px] text-[#D0E6F7] opacity-60 z-0" strokeWidth={1.5} />
            </div>
          </div>
          ...
          {/* Column 2 */}
          <div className="relative overflow-hidden flex flex-col  justify-center items-center bg-[#F2F8FD] rounded-[12px] p-4 md:p-6  h-full border border-[#EBF3F9]">
            <div className="relative z-10">
              <h4 className="font-semibold text-[#1C1C1D] text-[16px] md:text-[18px] mb-3">{additionalPageData.keyDetails.packFeatures.title}</h4>
              <p className="text-[#78788D] text-[14px] md:text-[16px] leading-relaxed pr-6">{additionalPageData.keyDetails.packFeatures.value}</p>
            </div>
            <Package className="absolute -right-4 -top-4 w-[100px] h-[100px] text-[#D0E6F7] opacity-60 z-0" strokeWidth={1.5} />
          </div>
          ...
          <div className="flex flex-col gap-3 md:gap-5">
            <div className="relative overflow-hidden bg-[#F2F8FD] rounded-[12px] p-4 md:p-6  h-full border border-[#EBF3F9]">
              <div className="relative z-10">
                <h4 className="font-bold text-[#1C1C1D] text-[16px] md:text-[18px] mb-2">{additionalPageData.keyDetails.benefits.title}</h4>
                <p className="text-[#78788D] text-[14px] md:text-[16px] leading-relaxed pr-4">{additionalPageData.keyDetails.benefits.value}</p>
              </div>
              <Handshake className="absolute -right-2 top-2 w-[70px] h-[70px] text-[#D0E6F7] opacity-60 z-0" strokeWidth={1.5} />
            </div>
            <div className="relative overflow-hidden bg-[#F2F8FD] rounded-[12px] p-4 md:p-6  h-full border border-[#EBF3F9]">
              <div className="relative z-10">
                <h4 className="font-bold text-[#1C1C1D] text-[16px] md:text-[18px] mb-2">{additionalPageData.keyDetails.documentTypes.title}</h4>
                <p className="text-[#78788D] text-[14px] md:text-[16px]">{additionalPageData.keyDetails.documentTypes.value}</p>
              </div>
              <FileText className="absolute -right-3 -bottom-3 w-[80px] h-[80px] text-[#D0E6F7] opacity-60 z-0" strokeWidth={1.5} />
            </div>
          </div>
      ...
      {/* --- TESTIMONIALS SECTION --- */}
      <div className="mb-12">
        <h2 className="text-[18px] md:text-[20px] font-semibold text-[#171717] mb-4">What our users say</h2>
        
        <div className="flex md:grid md:grid-cols-3 overflow-x-auto md:overflow-visible gap-4 md:gap-6 pt-8 md:pt-0 pb-2 md:pb-0 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
  {additionalPageData.testimonials.map((testimonial) => (
    <div key={testimonial.id} className="w-[85%] shrink-0 md:w-auto relative pt-10 px-8 pb-8 bg-[#FAFAFB] border border-[#EAECF0] rounded-[16px] text-center shadow-sm md:mt-4 snap-center">
      <img 
        src={testimonial.avatar} 
        alt={testimonial.author} 
        className="absolute -top-7 left-1/2 -translate-x-1/2 w-14 h-14 rounded-full border-[4px] border-white object-cover shadow-sm"
      ...
      {/* --- FAQ SECTION --- */}
      <div className="mb-8">
        <h2 className="text-[18px] md:text-[20px] font-semibold text-[#171717] mb-6">
          Frequently Asked Questions
        </h2>
          ...
          {faqData.map((faq) => {
            ...
            return (
              <div key={faq.id} className="flex flex-col">
                <button
                  onClick={() => toggleFaq(faq.id)}
                  className="flex items-center justify-between p-4 md:p-5 w-full text-left transition-colors hover:bg-[#F9FAFB]"
                >
                  <div className="flex items-center gap-4">
                    <span className="text-[16px] font-semibold text-[#171717]">
                      {faq.id}
                    </span>
                    <span className="text-[14px] md:text-[15px] text-[#78788D]">
                      {faq.question}
                    </span>
                  </div>
                  {isOpen ? (
                    <Minus className="w-[20px] h-[20px] ml-4 text-[#00A0E3] flex-shrink-0" strokeWidth={2} />
                  ) : (
                    <Plus className="w-[20px] h-[20px]  ml-4 text-[#00A0E3] flex-shrink-0" strokeWidth={2} />
                  )}
                </button>
                {isOpen && (
                  <div className="px-5 pb-5 pl-[46px]">
      ...
      {/* --- CONTACT SUPPORT SECTION --- */}
      <div className="mb-8">
        <div className="bg-[#F0F8FC] border border-[#E0F0F9] rounded-[16px] p-4 md:p-8">
          <h3 className="  text-[16px] md:text-[18px] font-semibold text-[#171717] mb-2">
            Have more questions for us?
          </h3>
          <p className="text-[#8A94A6] text-[14px] md:text-[15px] mb-8">
            Our specialists are always happy to help. Contact us during standard business hours or email us 24/7, and we'll get back to you.
          </p>
