...
values
  ('editing-domain', 'Editing', 'Editing domain for document refinement workflows', null, 'best', 'domain', 'Editing', 0.00, null, '["Hero Section","Other Services","FAQs","CTA Banner"]'::jsonb, true, true, 1, now()),
  ('proofreading-domain', 'Proofreading', 'Proofreading domain for language-level quality checks', null, 'other', 'domain', 'Proofreading', 0.00, null, '["Hero Section","Other Services","FAQs","CTA Banner"]'::jsonb, false, true, 2, now()),
  ('translation-domain', 'Translation', 'Translation domain for multilingual content support', null, 'other', 'domain', 'Translation', 0.00, null, '["Hero Section","Other Services","FAQs","CTA Banner"]'::jsonb, false, true, 3, now()),
  ('publication-support-domain', 'Publication Support', 'Publication support domain for journal-ready services', null, 'publication_support_packages', 'domain', 'Publication Support', 0.00, null, '["Hero Section","Other Packages","FAQs","CTA Banner"]'::jsonb, false, true, 4, now()),
  ('editing-basic', 'Basic Editing', 'Grammar and clarity improvements', null, 'best', 'service', 'Editing', 2.50, null, '["Hero Section","What is Included","Other Services","FAQs","CTA Banner"]'::jsonb, true, true, 10, now()),
  ('advanced-editing', 'Advanced Editing', 'Structure, tone, and clarity improvements', null, 'best', 'service', 'Editing', 3.25, null, '["Hero Section","What is Included","Other Services","FAQs","CTA Banner"]'::jsonb, false, true, 11, now()),
  ('proofreading-basic', 'Basic Proofreading', 'Spelling, grammar, and punctuation correction', null, 'other', 'service', 'Proofreading', 1.85, null, '["Hero Section","What is Included","Other Services","FAQs","CTA Banner"]'::jsonb, false, true, 12, now()),
  ('translation-en-es', 'Translation EN -> ES', 'Professional English to Spanish translation', null, 'other', 'service', 'Translation', 4.20, null, '["Hero Section","What is Included","Other Services","FAQs","CTA Banner"]'::jsonb, false, true, 13, now()),
  ('essential-support', 'Essential Support', 'Publication-ready support bundle', null, 'publication_support_packages', 'package', 'Editing', 0.00, 25800.00, '["Hero Section","Package Support","What is Included","Client Logos","How It Helps","Expert","FAQs","CTA Banner"]'::jsonb, false, true, 20, now()),
  ('advanced-support', 'Advanced Support', 'Expanded support bundle with added review steps', null, 'publication_support_packages', 'package', 'Editing', 0.00, 35800.00, '["Hero Section","Package Support","What is Included","Client Logos","How It Helps","Expert","FAQs","CTA Banner"]'::jsonb, false, true, 21, now()),
  ('comprehensive-support', 'Comprehensive Support', 'Premium bundle with the widest coverage', null, 'publication_support_packages', 'package', 'Editing', 0.00, 45800.00, '["Hero Section","Package Support","What is Included","Client Logos","How It Helps","Expert","FAQs","CTA Banner"]'::jsonb, false, true, 22, now()),
  ('plagiarism-check', 'Plagiarism Check', 'Similarity screening with report', null, 'other', 'service', 'Publication Support', 1.25, null, '["Hero Section","What is Included","Other Services","FAQs","CTA Banner"]'::jsonb, false, true, 30, now())
...
set title = excluded.title,
    ...
    page_sections = excluded.page_sections,
...
values
  (
    ...
    'Productivity is about doing the right things efficiently. This post breaks down a practical workflow system that keeps your work focused and manageable.',
    '[{"heading":"Identify Your Core Priorities","content":"Start by defining the top outcomes that actually matter for the week. This keeps your effort directed at meaningful work instead of busywork.","imageUrl":"https://images.unsplash.com/photo-1554415707-6e8cfc93fe23?auto=format&fit=crop&w=800&q=80"},{"heading":"Automate Repetitive Tasks","content":"If a step appears repeatedly, it is usually a candidate for automation. Saving even a few minutes per task compounds over time.","imageUrl":""},{"heading":"Establish Functional Boundaries","content":"Protect deep work by creating clear rules for when you check messages and how you manage interruptions.","imageUrl":"https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=800&q=80"}]'::jsonb,
    'Workflow optimization is an ongoing process of refinement. Prioritize deeply, automate ruthlessly, and protect your focus.',
    ARRAY['editing-basic','essential-support'],
    'published',
    true,
    now() - interval '1 day',
    'aaaaaaaa-1111-1111-1111-111111111111',
  ...
  (
    ...
    'Understanding the New Web Design Trends of 2026',
    'David Chen',
    'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&q=80',
    'As new aesthetics and interactive patterns emerge, it helps to understand what is actually shaping the web design space in 2026.',
    '[{"heading":"Design systems are getting leaner","content":"Teams are simplifying their component libraries so pages stay consistent and easier to maintain.","imageUrl":""},{"heading":"Motion is becoming more purposeful","content":"Rather than decorative animation everywhere, motion is being used to guide attention and explain state changes.","imageUrl":""}]'::jsonb,
    'Good design now balances clarity, motion, and speed.',
    ARRAY['translation-domain'],
    'published',
    false,
    now() - interval '2 days',
    'aaaaaaaa-1111-1111-1111-111111111111',
  ...
  (
    ...
    'The Ultimate Guide to Project Management Tools',
    'Elena Rodriguez',
    'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=1200&q=80',
    'Choosing the right tools can make or break a team''s workflow. This guide compares the decision factors that matter most.',
    '[{"heading":"Pick for the workflow, not the brand","content":"The best tool is the one that fits your process and team habits rather than the one with the loudest marketing.","imageUrl":""},{"heading":"Make adoption realistic","content":"Rollouts work better when you start small, document the process, and let the team actually use the tool in context.","imageUrl":""}]'::jsonb,
    'Choose tools that reduce friction, not add it.',
    ARRAY['advanced-support','comprehensive-support'],
    'draft',
    false,
    null,
    'aaaaaaaa-1111-1111-1111-111111111111',
