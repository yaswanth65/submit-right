...
const slides: HeroSlide[] = [
  {
    id: 1,
    tag: "Academic Editing & Publication Services",
    headline: "Your Research Is Brilliant. Don't Let Poor English Bury It.",
    description:
    ...
    metrics: [
      ...
      {
        value: "4.9/5",
        label: "Researcher Satisfaction",
      },
    ],
  },
  {
    id: 2,
    tag: "Our Service Domains",
    headline: "Find the Exact Academic Service You Need",
    description:
  ...
  },
  {
    ...
    headline: "Choose Your Level of Publication Support",
    description:
      "Whether you need a clean language edit or full end-to-end journal submission handling, Submit Right has a package built for your exact research stage.",
    primaryCta: "View All Packages",
    secondaryCta: "Get a Free Quote",
    metrics: [
      {
        value: "Unlimited",
        label: "Re-Editing on Premium Plans",
      },
      {
        value: "100%",
        label: "Satisfaction Guarantee or Full Refund",
      },
    ],
  },
];
...
export function Hero() {
  ...
  return (
    <section className="relative isolate hero-svg-bg w-full min-h-[100svh] sm:h-[100svh] overflow-x-hidden">
      <motion.div
          ...
          <div key={slide.id} className="w-full shrink-0">
            <div className="landing-shell relative z-20 min-h-[100svh] sm:h-full pt-[46px] sm:pt-[128px] lg:pt-[88px] pb-12 sm:pb-20 flex flex-col justify-start sm:justify-center">
              <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 items-start sm:items-center w-full mt-1 sm:mt-3 lg:mt-8">
                ...
                <div
                  className={`relative z-30 w-full flex items-start sm:items-center justify-center perspective-[1200px] mt-2 sm:mt-6 lg:mt-0 ${
                    idx === 0
                      ? "h-auto sm:h-[450px] lg:h-[650px]"
                      : "h-auto sm:h-[450px] lg:h-[650px]"
                  }`}
                >
                  {idx === 0 && <Slide1Right />}
      ...
      {/* Pagination Dots */}
      <div className="absolute bottom-5 sm:bottom-6 left-1/2 -translate-x-1/2 flex items-center justify-center gap-2 z-50">
        {slides.map((_, idx) => (
          <button
            key={idx}
...
function HeroSlideLeft({ slide }: { slide: HeroSlide }) {
  return (
    <div className="w-full relative z-30 flex flex-col items-center text-center lg:items-start lg:text-left">
      <div className="inline-flex items-center justify-center flex-wrap md:flex-nowrap gap-2 px-4 py-1.5 rounded-full border border-[#00A0E34D] bg-[#00A0E314] mb-6">
        ...
        <span className="text-[13px] md:text-[14px] font-medium leading-[1.4] text-[#00A0E3] md:whitespace-nowrap uppercase">
          {slide.tag}
        </span>
      </div>
      ...
      <p className="text-[15px] sm:text-[16px] md:text-[18px] text-[#78788D] leading-[1.45] md:leading-[1.4] mb-6 sm:mb-8 md:mb-10 lg:pr-6">
        {slide.description}
      </p>
          ...
          {slide.metrics.map((metric) => (
            <div key={metric.label} className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="font-medium text-[16px] text-[#1C1C1D]">{metric.value}</span>
                <span className="text-[14px] leading-[1.4] text-[#78788D]">{metric.label}</span>
              </div>
            </div>
          ))}
        </div>
...
function Slide1Right() {
  ...
  return (
    <div className="w-full flex justify-center">
      ...
      {/* ================= MOBILE VIEW ================= */}
      <div className="flex flex-col gap-3 w-full max-w-sm sm:hidden px-2">

        {/* Card 1 – Progress Overview */}
        <div className="bg-white rounded-2xl shadow-md p-3.5 border border-gray-100">
        ...
        {/* Card 2 – Gauge */}
        <div className="bg-white rounded-2xl shadow-md p-3.5 border border-gray-100 text-center">
        ...
        {/* Card 3 – Summary */}
        <div className="hidden min-[420px]:block bg-white rounded-2xl shadow-md p-3.5 border border-gray-100">
            ...
            >
              <div className="rounded-[14px] bg-white px-4 sm:px-5 pt-4 sm:pt-5 pb-3 sm:pb-4 border border-[#E4EBF2]">
                ...
                <div className="flex flex-row items-start w-[282px] h-[23px] bg-[#FA7319] rounded-[6px] overflow-visible mb-3 sm:mb-4 mt-4 sm:mt-6 p-0 isolate">
                  <div className="w-[180px] h-[23px] bg-[#1CB061] border-2 border-white rounded-[6px] -mx-[8px] z-10" />
                  <div className="w-[77px] h-[23px] bg-[#F4C252] border-2 border-white rounded-[6px] z-0" />
                </div>

                <div className="flex justify-between text-[10px] sm:text-xs px-0.5 sm:px-1">
                  <div className="text-center">
                    <p className="text-[#22C55E] font-normal text-[12px] sm:text-[14px] mb-0.5 sm:mb-1">78%</p>
                    <p className="text-[#9CA3AF] text-[10px] sm:text-[12px] font-medium">Successful</p>
                  </div>
                  <div className="text-center">
                    <p className="text-[#FBBF24] font-normal text-[12px] sm:text-[14px] mb-0.5 sm:mb-1">15%</p>
                    <p className="text-[#9CA3AF] text-[10px] sm:text-[12px] font-medium">Pending</p>
                  </div>
                  <div className="text-center">
                    <p className="text-[#F97316] font-normal text-[12px] sm:text-[14px] mb-0.5 sm:mb-1">02%</p>
                    <p className="text-[#9CA3AF] text-[10px] sm:text-[12px] font-medium">Failed</p>
                  </div>
                </div>
                <div className="w-full h-[2px] bg-[#E9EEF4] my-2 sm:my-3" />
