      ...
      <div className="w-full max-w-[1280px] mx-auto px-6 lg:px-10 xl:px-14">
        ...
        <div className="text-center max-w-[720px] mx-auto mb-10 lg:mb-12">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white border border-[#E5E5E5] rounded-full mb-4 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
            ...
            <span className="text-[11px] font-semibold text-[#1C1C1D] uppercase tracking-[0.12em]">
              LOREM IPSUM DOLOR
            </span>
          </div>
          ...
          {/* Description */}
          <p className="text-[14px] lg:text-[15px] text-[#65656D] leading-relaxed max-w-[560px] mx-auto">
        ...
        <div className="flex justify-center mb-12 lg:mb-14">
          <div className="inline-flex items-center w-full max-w-[560px] rounded-full border border-[#E5E5E5] bg-[#F7F8FA] p-1 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex-1 rounded-full px-4 py-2 text-[13px] font-medium transition-all duration-300 ease-out ${
                    isActive
        ...
        {/* Content Box */}
        <div className="grid lg:grid-cols-[1.02fr_0.98fr] gap-10 lg:gap-12 items-center max-w-5xl mx-auto">
          {/* Left Content */}
          <div className="pr-0 lg:pr-6">
            ...
            <h3 className="text-[32px] font-medium text-[#1C1C1D] leading-[1.1] mb-4 max-w-[360px]">
              Lorem ipsum dolor sit amet consectetur
            </h3>

            <p className="text-[14px] text-[#65656D] leading-relaxed mb-6 border-b border-[#F0F0F0] pb-6 max-w-[420px]">
              Lorem ipsum dolor sit amet consectetur. Sagittis eu vel habitant cursus. 
              Elementum suscipit donec viverra posuere at lorem nullam.
            </p>

            <ul className="space-y-3.5 mb-8 max-w-[420px]">
              {[1, 2, 3].map((item) => (
                <li key={item} className="flex items-start gap-3">
                  ...
                  <span className="text-[14px] font-medium text-[#1C1C1D] leading-[1.35]">
                    Lorem ipsum dolor sit amet consectetur
                  </span>
                </li>
              ))}
            ...
            <Link
              href="#"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#00A0E3] text-white text-[14px] font-medium rounded-full shadow-[0_4px_12px_rgba(0,160,227,0.18)] hover:bg-[#0189C2] transition-colors"
            >
              Submit Now
          ...
          <div className="relative bg-[#FAFAFA] rounded-2xl p-8 aspect-[4/3] flex items-center justify-center overflow-hidden border border-[#F0F0F0] shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
